...
void tempCmd(WebServer &server, WebServer::ConnectionType type, char *, bool)
{
  ...
  if (type != WebServer::HEAD)
  {
    ...
    server << "Strom Zähler:" << counter << "<br>\n<hr>";
  }
}
...
{ 
    ...
    {
        int wert = buf[0];
        if (wert >= schwellwert && !impuls) {
          digitalWrite(13, true); // Flash a light to show received good message
          counter++;
          Serial.print("\nImpuls gefunden. loopcount:");
          ...
          // count=75 pro kWh
          float kwh;
          kwh = loopcount / 10.0 * 75.0;
          Serial.print("\tZeit pro kWh (in sek): ");
          Serial.print(kwh);
          
          float kwh_pro_std = 3600.0/kwh;
          Serial.print("\tkwh pro Stunde: ");
          Serial.print(kwh_pro_std);          
          Serial.println(".");
